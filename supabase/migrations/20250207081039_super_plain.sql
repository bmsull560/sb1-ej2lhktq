...
-- Create indexes
CREATE INDEX IF NOT EXISTS idx_privacy_laws_state_code ON public.privacy_laws(state_code);
CREATE INDEX IF NOT EXISTS idx_law_provisions_law_id ON public.law_provisions(law_id);
