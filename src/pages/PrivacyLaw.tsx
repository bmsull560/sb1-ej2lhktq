...
export function PrivacyLaw() {
  const [selectedState, setSelectedState] = useState<string | null>(null);

  const handleStateSelect = (stateCode: string) => {
    console.log('PrivacyLaw: handleStateSelect called with:', stateCode);
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 bg-gray-900/50 p-6 rounded-xl backdrop-blur-sm border border-gray-800">
            <USAMap selectedState={selectedState} onStateSelect={handleStateSelect} />
          </div>
